...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-7">
                <a href="<?php echo get_permalink(woocommerce_get_page_id('shop')); ?>" class="back-to-shop"><i class="fas fa-chevron-left"></i>Continue Shopping</a>

            </div>
            <div class="col-lg-5">
                <table cellspacing="0" class="shop_table shop_table_responsive wc-total-info">
